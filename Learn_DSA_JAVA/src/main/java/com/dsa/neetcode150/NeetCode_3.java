...
public class NeetCode_3 {
	 ...
	 * j] such that: • nums[i] + nums[j] == target • i != j The answer should be
	 * returned with the smaller index first. You may assume that there is exactly
	 * one unique solution for every input.
	 */
	// ** NOTE ** //
